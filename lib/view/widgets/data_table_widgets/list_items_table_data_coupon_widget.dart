...
class ListItemsTableWidgetCoupon extends StatelessWidget {
  ...
  ListItemsTableWidgetCoupon({super.key, required this.listData});
                  ...
                  onPressed: () {
                    showDialog(context: context, builder: (context) {
                      return AlternativeDropPopup(
                        list: CommonData.couponStatusRawData(),
                        callBack: (selectedValue) {
                          final model = CouponModel(
                            firebaseCollectionID: e.firebaseCollectionID,
                            status: selectedValue,
                            code: e.code,
                            campaignName: e.campaignName,
                            discount: e.discount,);
                          couponServices.updateStatus(model, context);
                        },);
                    });
                  },
